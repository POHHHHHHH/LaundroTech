...
function updateRow() {
    ...
    if (tableName === "Booking") {
        ...
        var raw = JSON.stringify({
            "query": "UPDATE laundrotech.Booking SET FK_timeslotID = '" + timeslotID + "', FK_washingMachineID = '" + washingMachineID + "', bookingDate = '" + bookingDate + "', startTime = '" + startTime + "', endTime = '" +
        ...
        var raw = JSON.stringify({
            "query": "UPDATE laundrotech.User SET role = '" + role + "', fullName = '" + fullName + "', email = '" + email + "', contactNo = '" + contactNo + "', credit = '" +
        ...
        var raw = JSON.stringify({
            "query": "UPDATE laundrotech.WashingMachine SET location = '" + location + "', washingMachineAddress = '" +
...
function createEntry() {
    ...
    if (tableName === "Booking") {
        ...
        var raw = JSON.stringify({
            "query": "INSERT INTO laundrotech.Booking(FK_userID,FK_timeslotID,FK_washingMachineID,bookingDate,startTime,endTime,bookingStatus,bookingCode)VALUES('" + userID + "','" + timeslotID + "','"
        ...
        var raw = JSON.stringify({
            "query": "INSERT INTO laundrotech.Payment(FK_userID,FK_bookingID,price,status)VALUES('" + userID + "','" + bookingID + "','"
                + price + "','" + status + "')"
        });
        ...
        var raw = JSON.stringify({
            "query": "INSERT INTO laundrotech.WashingMachine(location,washingMachineAddress,price,washingMachineBrand,washingMachineModel)VALUES('" + location + "','" + washingMachineAddress + "','"
    ...
    fetch("https://3rczj928aa.execute-api.us-east-1.amazonaws.com/prod/admin", requestOptions)
        ...
        .then(result => {
            ...
            if (data.length > 0) {
                ...
                raw = JSON.stringify({
                    "query": "INSERT INTO laundrotech.User(username,password,role,fullName,email,contactNo,credit)VALUES('" + username + "','plaintextPW','" + role + "','" + fullName + "','" +
