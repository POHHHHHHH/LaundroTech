function loadInvoice(){
    ...
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">" + day + " " + month + " " + year + "</td>";
    document.getElementById("bookingDate").innerHTML = str;

    str = "<td class=\"col-md-1\" id=\"washingMachineID\">" + sessionStorage.getItem("bookingTime") + "</td>";
    document.getElementById("bookingTime").innerHTML = str;
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">" + sessionStorage.getItem("location") + "</td>";
    document.getElementById("location").innerHTML = str;
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">" + sessionStorage.getItem("washingMachineAddress") + "</td>";
    document.getElementById("washingMachineAddress").innerHTML = str;
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">$" + sessionStorage.getItem("price") + "</td>";
    document.getElementById("price").innerHTML = str;
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">$1</td>";
    document.getElementById("bookingFee").innerHTML = str;
    str = "<td class=\"col-md-1\" id=\"washingMachineID\">" + sessionStorage.getItem("bookingCode") + "</td>";
